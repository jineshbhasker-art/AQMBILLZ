...
export default function Repairs() {
  ...
  const getStatusColor = (status: RepairStatus) => {
    switch (status) {
      case RepairStatus.RECEIVED: return "bg-gray-100 text-gray-600";
      case RepairStatus.DIAGNOSING: return "bg-blue-100 text-blue-600";
      case RepairStatus.REPAIRING: return "bg-purple-100 text-purple-600";
      case RepairStatus.READY: return "bg-green-100 text-green-600";
      case RepairStatus.DELIVERED: return "bg-black text-white";
      case RepairStatus.CANCELLED: return "bg-red-100 text-red-600";
  ...
  return (
    <div className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          <h1 className="font-display text-5xl font-black tracking-tighter uppercase">REPAIR <span className="text-[#C5A059]">TERMINAL</span></h1>
          <p className="text-gray-400 mt-1 uppercase text-[10px] font-black tracking-[0.3em]">
             System Node: {profile?.companyName || 'AL QUSAIDAT MOBILES'} • LOGISTICS HUB
          </p>
        </div>
        <button 
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-gray-50/50 border-b border-gray-50">
                    <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Sequence / ID</th>
                    <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Client Hub</th>
                    <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Device Entity</th>
                    <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Operational Level</th>
                    <th className="px-10 py-6 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">Yield Margin</th>
                ...
                <tbody className="divide-y divide-gray-50">
                  {filteredRepairs.map((repair) => (
                    ...
                    >
                      ...
                      <td className="px-10 py-8">
                        <div className="flex items-center gap-4">
                           <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center text-gray-200 group-hover:scale-110 transition-transform">
                              <Smartphone size={20} />
                           </div>
                           <div>
                              <div className="text-sm font-black uppercase tracking-tighter">{repair.deviceModel}</div>
                              <div className="text-[10px] text-red-400 font-bold uppercase tracking-tight mt-1 truncate max-w-[120px]">{repair.issue}</div>
                           </div>
                        </div>
                      </td>
                      <td className="px-10 py-8">
             ...
             {selectedRepair ? (
               ...
               >
                 ...
                 <div className="space-y-2">
                    <div className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-300 leading-none">ORDER_IDENTIFIER</div>
                 ...
                 <div className="space-y-8 border-t border-gray-50 pt-8">
                    ...
                    <div className="p-6 bg-gray-50 rounded-[2rem] border border-gray-100">
                       <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-3">DIAGNOSTIC REPORT</p>
               ...
               <div className="advanced-3d-card p-12 bg-gray-50 border border-gray-100 h-full min-h-[400px] flex flex-col items-center justify-center text-center space-y-8 opacity-40">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[9px] font-bold uppercase tracking-widest leading-loose">Initialize nexus via job selection <br/> or search parameters</p>
                  </div>
               </div>
             )}
           </AnimatePresence>
             ...
             <motion.div initial={{ scale: 0.9, opacity: 0, y: 100 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 100 }} className="relative w-full max-w-4xl bg-white rounded-[4rem] shadow-[0_50px_100px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col max-h-[90vh]">
                <div className="p-12 border-b border-gray-50 flex items-center justify-between sticky top-0 bg-white z-10">
                   <div className="flex items-center gap-6">
                      ...
                      <div>
                         <h2 className="text-3xl font-black font-display tracking-tight uppercase">REPOSITORY SYNC</h2>
                         <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.3em] mt-2">Associate entity to repair Nexus</p>
                      </div>
                   </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                      <div className="space-y-10">
                         <div className="flex items-center gap-4">
                            ...
                            <label className="text-[10px] font-black uppercase tracking-[0.4em] text-black">DEVICE CALIBRATION</label>
                         </div>
                         <div className="space-y-6">
                            <div className="space-y-2">
                               <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Entity Model</label>
                               <input 
                                 type="text" 
                                 required
                                 ...
                                 placeholder="e.g. SONY PLAYSTATION 5 / IPHONE 15"
                               />
                            </div>
                            <div className="space-y-2">
                               <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Nexus Identifier (IMEI/SERIAL)</label>
                               <input 
                                 type="text" 
                                 ...
                                 placeholder="SERIAL_NODE_00X"
                               />
                            </div>
                            <div className="space-y-2">
                               <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Failure Symptom</label>
                               <textarea 
                                 required
                                 rows={4}
                                 ...
                                 placeholder="DESCRIBE INTEGRITY FAILURE..."
                               />
                            </div>
                         </div>
                      </div>
